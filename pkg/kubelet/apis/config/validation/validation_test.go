...
func TestValidateKubeletConfiguration(t *testing.T) {
	...
	cases := []struct {
		...
		// {
		// 	name: "invalid RtPeriod",
		// 	configure: func(conf *kubeletconfig.KubeletConfiguration) *kubeletconfig.KubeletConfiguration {
		// 		conf.RTPeriod.Duration = 0
		// 		conf.RTHCBS = true
		// 		conf.FeatureGates = map[string]bool{"CustomCPUCFSQuotaPeriod": false}
		// 		return conf
		// 	},
		// 	errMsg: "invalid configuration: RTPeriod must be set when RTHCBS is enabled",
		// }, {
		// 	name: "invalid scheduling policies",
		// 	configure: func(conf *kubeletconfig.KubeletConfiguration) *kubeletconfig.KubeletConfiguration {
		// 		conf.RTHCBS = true
		// 		conf.FeatureGates = map[string]bool{"CustomCPUCFSQuotaPeriod": true}
		// 		return conf
		// 	},
		// 	errMsg: "invalid configuration: cpuCFSQuota and RTHCBS are enabled at the same time",
		// },
		{
